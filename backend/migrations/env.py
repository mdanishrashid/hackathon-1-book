...
from backend.src.models import *  # Import all models for Alembic to detect
from backend.src.database import SQLALCHEMY_DATABASE_URL  # Import the database URL
...
# Import all models to reflect them in metadata
from backend.src.models.chapter import Chapter
from backend.src.models.learning_step import LearningStep
from backend.src.models.learning_progress import LearningProgress
...
target_metadata = Chapter.metadata
